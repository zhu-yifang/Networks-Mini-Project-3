"""
Utility script for testing MP3 solutions under user set conditions.
"""
import time
import argparse
import subprocess
...
LOGGER = miniproject3.logging.get_logger("mp3-tester")
if ARGS.verbose:
...
INPUT_LEN, INPUT_HASH = miniproject3.utils.file_summary(INPUT_PATH)
...
RECV_LEN, RECV_HASH = miniproject3.utils.file_summary(RECV_PATH)
